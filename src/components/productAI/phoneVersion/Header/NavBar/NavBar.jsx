...
const IconSideNav = () => {
	return (
		<div className='bg-slate-900 text-slate-100 flex mt-0 fixed z-10'>
			<SideNav />
		</div>
	)
}
...
const SideNav = () => {
	...
	return (
		...
		<nav className='w-screen h-fit bg-slate-900 p-4 flex flex-row items-center gap-5 justify-center'>
