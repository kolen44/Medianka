...
export default function ResponseBlockquote() {
	const blockquotesFromYandexGPT = useStores(
		state => state.blockquotesFromYandexGPT
	)
	return (
		<blockquote className='relative text-end h-fit max-w-2xl'>
